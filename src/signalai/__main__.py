...
from signalai.cli import clinic_index_main


def main() -> None:
    parser = argparse.ArgumentParser(prog="python -m signalai")
    parser.add_argument("command", choices=["daily", "publish", "should-commit", "clinic-ingest", "clinic-batch", "clinic-scheduled", "clinic-discover", "clinic-index", "clinic-enrich", "clinic-import"])
    ...
    if args.command in {"clinic-discover", "clinic-index", "clinic-enrich", "clinic-import"}:
