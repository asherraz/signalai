...
def main() -> None:
    ...
    parser.add_argument("command", choices=["daily", "publish", "should-commit", "clinic-ingest", "clinic-batch", "clinic-scheduled", "clinic-discover", "clinic-index", "clinic-enrich", "clinic-import", "clinic-simulate"])
